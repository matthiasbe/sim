...
\section{Cas séquentiel}
	...
	\subsection{\'Etude de convergence}
		...
		On peut tout d'abord observer sur les figures \ref{fig:Nvse-m_p6}, \ref{fig:Nvse-m_p8} et \ref{fig:Nvse-m_p10} l'impact du choix de la taille du sous espace de Krylov.
